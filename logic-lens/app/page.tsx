...
export default function LogicLens() {
  ...
  return (
    <div
      id="main-layout"
      className="h-[100dvh] w-screen bg-slate-50 text-slate-900 flex flex-col lg:flex-row overflow-hidden font-sans"
    >
      {/* SIDEBAR (Controls) */}
          ...
          >
            ...
            <div className="flex items-center gap-1">
              ...
              <input
                ...
                onBlur={handleBlur}
                placeholder="A'B'..."
                className={`w-full bg-transparent border-none focus:outline-none text-xl lg:text-2xl font-sans font-black placeholder-slate-300 uppercase tracking-tight
